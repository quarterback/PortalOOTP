...
def add_batter_tab(notebook, font):
    ...
    filter_frame = tk.Frame(batter_frame, bg="#2d2d2d", highlightthickness=0, bd=0)
    ...
    btn_frame = tk.Frame(filter_frame, bg="#2d2d2d")
    ...
    controls = tk.Frame(batter_frame, bg="#2d2d2d", highlightthickness=0, bd=0)
    ...
    table_frame = tk.Frame(batter_frame, bg="#2d2d2d", highlightthickness=0, bd=0)
